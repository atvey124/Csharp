...
Console.WriteLine("Второе по величине число в массиве: " + second_max + " Второй по величине индекс в массиве: " + second_max_index);
                                                                                        ...
                                                                                        // функции(void)
void results2(int num) // void - инициализация функции,далее идет присвоение ей имени,далее в скобочках указываются параметры,или же локальные переменные функции
{
